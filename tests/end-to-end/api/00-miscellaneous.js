...
describe('miscellaneous', function () {
	...
	it('/me', done => {
		request
			...
			.expect(res => {
				...
				expect(res.body)
					.to.have.nested.property('settings.preferences')
					.and.to.be.an('object');
				expect(res.body.settings.preferences).to.include.keys(
					allUserPreferencesKeys
				);
			})
			.end(done);
	});
	...
	describe('[/instances.get]', () => {
		...
		before(async () => {
			...
			unauthorizedUserCredentials = await doLogin(
