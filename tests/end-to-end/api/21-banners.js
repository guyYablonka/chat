			...
			request
				...
				.expect(res => {
					...
					expect(res.body).to.have.property(
						'error',
						"Match error: Missing key 'platform'"
					);
				})
				.end(done);
		});
		...
		it('should fail if platform param is unknown', done => {
			request
				...
				.expect(res => {
					...
					expect(res.body).to.have.property(
						'error',
						'Platform is unknown. [error-unknown-platform]'
					);
					expect(res.body).to.have.property(
						'errorType',
		...
		it('should fail if platform param is empty', done => {
			request
				...
				.expect(res => {
					...
					expect(res.body).to.have.property(
						'error',
						'The required "platform" param is missing. [error-missing-param]'
					);
					expect(res.body).to.have.property(
						'errorType',
						'error-missing-param'
		...
		it('should fail if missing bannerId key', done => {
			request
				...
				.expect(res => {
					...
					expect(res.body).to.have.property(
						'error',
						"Match error: Missing key 'bannerId'"
					);
				})
				.end(done);
		});
		...
		it('should fail if missing bannerId is empty', done => {
			request
				...
				.expect(res => {
					...
					expect(res.body).to.have.property(
						'error',
						'The required "bannerId" param is missing. [error-missing-param]'
					);
					expect(res.body).to.have.property(
						'errorType',
						'error-missing-param'
