...
Migrations.add({
	...
	up() {
		Users.find(
			...
			if (
				user.settings.preferences.desktopNotifications &&
				user.settings.preferences.desktopNotifications !== 'default'
			) {
			...
			if (
				user.settings.preferences.mobileNotifications &&
				user.settings.preferences.mobileNotifications !== 'default'
			) {
				Subscriptions.update(
					{
						'u._id': user._id,
			...
			if (
				user.settings.preferences.emailNotificationMode &&
				user.settings.preferences.emailNotificationMode !== 'default'
			) {
				Subscriptions.update(
					{
						'u._id': user._id,
