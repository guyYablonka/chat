...
const SettingsProvider: FunctionComponent<SettingsProviderProps> = ({
    ...
    const querySetting = useMemo(
        () =>
            createReactiveSubscriptionFactory(_id => ({
                ...cachedCollection.collection.findOne(_id)
            })),
        [cachedCollection]
    );
    ...
    return (
        <SettingsContext.Provider children={children} value={contextValue} />
    );
};
