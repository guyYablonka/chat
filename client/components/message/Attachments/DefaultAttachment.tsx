    ...
    return (
        <Attachment.Block
            ...
            pre={
                attachment.pretext && (
                    <Attachment.Text>
                        {applyMardownFor('pretext', attachment.pretext)}
                    </Attachment.Text>
                )
            }
        >
            <Attachment.Content>
                ...
                {!collapsed && (
                    <>
                        {attachment.text && (
                            <Attachment.Text>
                                {applyMardownFor('text', attachment.text)}
                            </Attachment.Text>
                        )}
            ...
            {attachment.thumb_url && (
                <Attachment.Thumb url={attachment.thumb_url} />
            )}
        </Attachment.Block>
    );
};
