...
function SortModeList() {
	...
	const useHandleChange = value =>
		useCallback(() => saveUserPreferences({ sidebarSortby: value }), [
			value
		]);
...
function GroupingList() {
	...
	const handleChangeGroupByType = useHandleChange(
		'sidebarGroupByType',
		!sidebarGroupByType
	);
	const handleChangeShoFavorite = useHandleChange(
		'sidebarShowFavorites',
		!sidebarShowFavorites
	);
	const handleChangeShowUnread = useHandleChange(
		'sidebarShowUnread',
		!sidebarShowUnread
	);
