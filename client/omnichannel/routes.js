...
createTemplateForComponent(
	'omnichannelFlex',
	() => import('./sidebar/OmnichannelSidebar'),
	{
		renderContainerView: () =>
...
registerOmnichannelRoute('/customfields/:context?/:id?', {
	...
	lazyRouteComponent: () =>
		import('../views/omnichannel/customFields/CustomFieldsRoute')
});
...
registerOmnichannelRoute('/units/:context?/:id?', {
	...
	lazyRouteComponent: () =>
		import('../../../ee/client/omnichannel/units/UnitsRoute')
});

registerOmnichannelRoute('/tags/:context?/:id?', {
	name: 'omnichannel-tags',
	lazyRouteComponent: () =>
		import('../../../ee/client/omnichannel/tags/TagsRoute')
});

registerOmnichannelRoute('/priorities/:context?/:id?', {
	name: 'omnichannel-priorities',
	lazyRouteComponent: () =>
		import('../../../ee/client/omnichannel/priorities/PrioritiesRoute')
});
...
registerOmnichannelRoute('/realtime-monitoring', {
	...
	lazyRouteComponent: () =>
		import('./realTimeMonitoring/RealTimeMonitoringPage')
});
