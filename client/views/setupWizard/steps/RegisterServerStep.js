...
const Option = React.forwardRef(
	({ children, label, selected, disabled, ...props }, ref) => {
		...
		return (
			<Box
				className={[
					...
					selected &&
						'SetupWizard__RegisterServerStep-option--selected'
				]
					.filter(Boolean)
					.join(' ')}
				display="block"
					...
					<Box display="flex" flexDirection="column">
						...
						>
							<Items>
								...
								<Item icon="check">
									{t(
										'Register_Server_Registered_Marketplace'
									)}
								</Item>
							</Items>
							<Field>
								<Field.Row>
									...
									/>
									<Field.Label
										htmlFor={optInMarketingEmailsId}
									>
						...
						<Margins all="x16">
							<Field>
								<Field.Row>
									...
									/>
									<Field.Label
										htmlFor={agreeTermsAndPrivacyId}
									>
										{t(
											'Register_Server_Registered_I_Agree'
										)}{' '}
										<a href="https://rocket.chat/terms">
											{t('Terms')}
										</a>{' '}
										&{' '}
										<a href="https://rocket.chat/privacy">
											{t('Privacy_Policy')}
										</a>
									</Field.Label>
								</Field.Row>
