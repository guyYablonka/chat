...
createTemplateForComponent(
	'Burger',
	() => import('../views/room/Header/Burger'),
	{
		renderContainerView: () => HTML.DIV() // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	...
	() => import('./contextualBar/Discussions'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'ExportMessages',
	() => import('./contextualBar/ExportMessages'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'KeyboardShortcuts',
	() => import('./contextualBar/KeyboardShortcuts'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'AutoTranslate',
	() => import('./contextualBar/AutoTranslate'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'InviteUsers',
	() => import('./contextualBar/RoomMembers/InviteUsers'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'EditInvite',
	() => import('./contextualBar/RoomMembers/EditInvite'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'membersList',
	() => import('./contextualBar/RoomMembers'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'EditRoomInfo',
	() => import('./contextualBar/Info/EditRoomInfo'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'RoomInfo',
	() => import('./contextualBar/Info/RoomInfo'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
...
createTemplateForComponent(
	'PruneMessages',
	() => import('./contextualBar/PruneMessages'),
	{
		renderContainerView: () => HTML.DIV({ class: 'contextual-bar' }) // eslint-disable-line new-cap
	}
);
