...
const TriggersForm: FC<TriggersFormProps> = ({
    values,
    handlers,
    className
}) => {
    ...
    const handleConditionValue = useMutableCallback(
        ({ currentTarget: { value } }) => {
            handleConditions({
                ...conditions,
                value
    ...
    const handleActionAgentName = useMutableCallback(
    ...
    const handleActionMessage = useMutableCallback(
