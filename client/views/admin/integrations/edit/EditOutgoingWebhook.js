...
import {
	triggerWordsToArray,
	triggerWordsToString
} from '../helpers/triggerWords';

export default function EditOutgoingWebhookWithData({
	integrationId,
	...props
}) {
...
function EditOutgoingWebhook({ data, onChange, setSaveAction, ...props }) {
	...
	const { handlers: formHandlers, values: formValues, reset } = useForm(
	...
	const deleteIntegration = useEndpointAction(
		'POST',
		'integrations.remove',
		deleteQuery
	);
