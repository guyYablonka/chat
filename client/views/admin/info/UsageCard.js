...
const UsageCard = React.memo(function UsageCard({
	statistics,
	isLoading,
	vertical
}) {
				...
				<Card.Col>
					...
					<Card.Col.Section>
						...
						<TextSeparator
							...
							value={s(() =>
								formatMemorySize(statistics.uploadsTotalSize)
							)}
						/>
					</Card.Col.Section>
				</Card.Col>
				...
				<Card.Col>
					<Card.Col.Section>
						...
						<TextSeparator
							label={
								<>
									<Card.Icon name="dialpad" size="x16" />{' '}
									{t('Stats_Total_Rooms')}
								</>
							}
						...
						<TextSeparator
							label={
								<>
									<Card.Icon name="discussion" size="x16" />{' '}
									{t('Total_Discussions')}
								</>
							}
						...
						<TextSeparator
							label={
								<>
									<Card.Icon name="headset" size="x16" />{' '}
