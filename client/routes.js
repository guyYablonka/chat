...
FlowRouter.route('/developers-page', {
	name: 'developers-page',

	action() {
		renderRouteComponent(
			() => import('./views/developersPage/DevelopersPage'),
			{
				template: 'main',
				region: 'center'
			}
...
FlowRouter.route('/setup-wizard/:step?', {
	...
	action: () => {
		renderRouteComponent(() =>
			import('./views/setupWizard/SetupWizardRoute')
		);
	}
});

FlowRouter.route('/questions-answers-page', {
	name: 'questions-answers-page',

	action() {
		renderRouteComponent(
			() =>
				import(
					'./views/questionsAndAnswersPage/QuestionsAndAnswersPage'
				),
			{
				template: 'main',
				region: 'center'
