...
export const CondensedWithAvatar = () => (
	<CondensedSkeleton showAvatar={true} />
);
export const CondensedWithoutAvatar = () => (
	<CondensedSkeleton showAvatar={false} />
);
...
export const ExtendedWithoutAvatar = () => (
	<ExtendedSkeleton showAvatar={false} />
);
