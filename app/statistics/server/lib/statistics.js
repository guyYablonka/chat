...
export const statistics = {
	get: function _getStatistics() {
		...
		statistics.busyUsers = Meteor.users
			.find({ statusConnection: 'busy' })
			.count();
		...
		statistics.federatedUsers =
			federationOverviewData.numberOfFederatedUsers;
