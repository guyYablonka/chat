...
const stopTyping = rid =>
	Notifications.notifyRoom(rid, 'typing', shownName(Meteor.user()), false);
const typing = rid =>
	Notifications.notifyRoom(rid, 'typing', shownName(Meteor.user()), true);
	...
	constructor() {
		Tracker.autorun(
			() =>
				...
				this.addStream(Session.get('openedRoom'))
		);
	}

	get selfTyping() {
		return selfTyping.get();
	}
