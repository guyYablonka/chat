...
settings.addGroup('FileUpload', function () {
	...
	this.add('FileUpload_MaxFileSize', 31457280, {
		type: 'int',
		public: true,
	...
	this.add('FileUpload_MediaTypeWhiteList_Mobile', 'pdf', {
		type: 'string',
		public: true,
		i18nDescription: 'FileUpload_MediaTypeWhiteListDescription_Mobile'
	});
	...
	this.section('File_Names', function () {
		this.add('Enable_fileNames_Validation', true, {
			type: 'boolean',
			public: true
		});
		this.add('FileName_MaxLength', 200, {
			type: 'int',
			public: true,
			enableQuery: {
				_id: 'Enable_fileNames_Validation',
				value: true
			}
		});
		return this.add('FileName_Regex', '^[^\\\\<>/*"?|]+$', {
			type: 'string',
			public: true,
			enableQuery: {
				_id: 'Enable_fileNames_Validation',
