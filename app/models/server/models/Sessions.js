...
export const aggregates = {
	...
	getUniqueUsersOfLastMonthOrWeek(
		collection,
		{ year, month, day, type = 'month' }
	) {
		return collection
			.aggregate(
				[
	...
	getUniqueDevicesOfLastMonthOrWeek(
		collection,
		{ year, month, day, type = 'month' }
	) {
		return collection
...
export class Sessions extends Base {
	constructor(...args) {
		...
		this.secondaryCollection = db.collection(this.model._name, {
	...
	getUniqueUsersOfYesterday() {
		...
		return {
			...
			day,
			data: Promise.await(
				aggregates.getUniqueUsersOfYesterday(this.secondaryCollection, {
					year,
					month,
					day
				})
	...
	getUniqueUsersOfLastMonth() {
		...
		return {
			...
			day,
			data: Promise.await(
				aggregates.getUniqueUsersOfLastMonthOrWeek(
	...
	getUniqueDevicesOfYesterday() {
		...
		return {
			...
			day,
			data: Promise.await(
				aggregates.getUniqueDevicesOfYesterday(
					this.secondaryCollection,
					{ year, month, day }
				)
			)
	...
	getUniqueDevicesOfLastMonth() {
		...
		return {
			...
			day,
			data: Promise.await(
				aggregates.getUniqueDevicesOfLastMonthOrWeek(
					this.secondaryCollection,
					{ year, month, day }
				)
			)
	...
	getUniqueOSOfYesterday() {
		...
		return {
			...
			day,
			data: Promise.await(
				aggregates.getUniqueOSOfYesterday(this.secondaryCollection, {
					year,
					month,
					day
				})
	...
	getUniqueOSOfLastMonth() {
		...
		return {
			...
			day,
			data: Promise.await(
				aggregates.getUniqueOSOfLastMonthOrWeek(
					this.secondaryCollection,
					{ year, month, day }
				)
			)
