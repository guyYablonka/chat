...
import { extractRoomMemberAddition } from './extractions/extractRoomMemberAddition';
...
export const addUserToRoom = function (
	...
	for (dest of Object.keys(userDestinations)) {
		Rooms.incDestinationsCount(rid, dest, room._updatedAt);
	}
	...
	extractRoomMemberAddition(room, user, extraData);
