...
import { extractRoomCreation } from './extractions/extractRoomCreation';
...
export const createRoom = function (
	...
	const roomDestinations = getDestinations(members);

	if (!_.isEmpty(roomDestinations)) {
		room.destinations = roomDestinations;
	}
	...
	extractRoomCreation(room, proxyData);
