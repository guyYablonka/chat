...
import { extractMessageSending } from './extractions/extractMessageSending';
import { removeQuoteUrl } from '../../../ui-utils/lib/MessageProperties';
/**
 * IMPORTANT
 *
...
export const sendMessage = function (
	...
	if (message.parseUrls !== false) {
		...
		message.msg = removeQuoteUrl(message.html);
		delete message.html;
	...
	if (message) {
		if (message._id && upsert) {
			...
			message._id = Messages.insertOrUpsert(message);

			extractMessageSending(room, message, extraData);
		}
