...
settings.get('Accounts_Password_Policy_Enabled', (key, value) => {
	passwordPolicy.enabled = value;
});
settings.get('Accounts_Password_Policy_MinLength', (key, value) => {
	passwordPolicy.minLength = value;
});
settings.get('Accounts_Password_Policy_MaxLength', (key, value) => {
...
settings.get('Accounts_Password_Policy_AtLeastOneLowercase', (key, value) => {
	passwordPolicy.mustContainAtLeastOneLowercase = value;
});
settings.get('Accounts_Password_Policy_AtLeastOneUppercase', (key, value) => {
	passwordPolicy.mustContainAtLeastOneUppercase = value;
});
settings.get('Accounts_Password_Policy_AtLeastOneNumber', (key, value) => {
