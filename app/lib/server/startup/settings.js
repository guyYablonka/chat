...
settings.addGroup('Accounts', function () {
	...
	this.add('Accounts_ShowPresenceStatus', false, {
		type: 'boolean',
		public: true
	});
	this.add('Accounts_AllowUserLogout', false, {
		type: 'boolean',
		public: true
	});
	...
	this.add('Accounts_AllowUserStatusMessageChange', false, {
		type: 'boolean',
		public: true
	});
	...
	this.add('Accounts_AllowEmailNotifications', false, {
		type: 'boolean',
		public: true
	});
	this.add(
		'Accounts_CustomFieldsToShowInUserInfo',
		`{"custom_fields_first_name": "firstName", "custom_fields_last_name": "lastName", "custom_fields_personal_number": "personalNumber"}`,
		{
			type: 'string',
			public: true
		}
	...
	this.add(
		'Accounts_DefultUsersInfoFieldsToShow',
		`{ "name": 1,
			   "username": 1,
			   "nickname": 1,
			   "status": 1,
		...
		{
			type: 'code',
			i18nLabel: 'Accounts_DefultUsersInfoFieldsToShow'
		}
	);
	this.add('Accounts_LoginTokenMax', 4, {
		type: 'int',
		public: true
	});
	...
	this.add('Accounts_UserAgentsLimit', 3, {
		type: 'int',
		public: true
	});
	this.add('Accounts_ShowFormLogin', false, {
		type: 'boolean',
		public: true
	});
	this.add('Accounts_EnableSwitchLanguage', false, {
		type: 'boolean',
		public: true
	});
	...
	this.add(
		...
		'username, name, bio, nickname, customFields.firstName, customFields.lastName, customFields.fullName, customFields.personalNumber',
		{
			type: 'string'
		}
	);
	...
	this.section('Registration', function () {
		...
		this.add('Accounts_RequirePasswordConfirmation', false, {
			type: 'boolean',
			public: true
		});
		...
		this.add('Accounts_Verify_Email_For_External_Accounts', false, {
			type: 'boolean'
		});
		...
		this.add(
			...
			`{ "firstName": { "type": "text", "required": false, "minLength": 2, "maxLength": 20, "public": true }, "lastName": { "type": "text", "required": false, "minLength": 2, "maxLength": 20, "public": true }, "fullName": { "type": "text", "required": false, "minLength": 2, "maxLength": 20, "public": true }, "personalNumber": { "type": "text", "required": false, "minLength": 2, "maxLength": 20, "public": true }, "classificationLevel": { "type": "text", "defaultValue": 5, "required": false, "minLength": 1, "maxLength": 2, "public": true } }`,
			{
				type: 'code',
				public: true,
	...
	this.section('Password_Policy', function () {
		...
		const passwordRegex = `^[0-9a-zA-z]{6,50}$`;

		this.add('Accounts_Password_Policy_PasswordRegex', passwordRegex, {
			type: 'string',
			i18nLabel: 'Password Regex',
			public: true,
			enableQuery
		});
...
settings.addGroup('OAuth', function () {
	this.section('MobileAuth', function () {
		const enableQuery = {
			_id: 'Accounts_OAuth_MobileAuth',
			value: true
		};
		this.add('Accounts_OAuth_MobileAuth', false, {
			type: 'boolean',
			public: true
		});
		this.add('Accounts_OAuth_MobileAuth_serviceName', 'mobileauth', {
			type: 'string',
			enableQuery,
			public: true,
			i18nLabel: 'Accounts_OAuth_Custom_Service_Name'
		});
		this.add('Accounts_OAuth_MobileAuth_URL', '', {
			type: 'string',
			enableQuery,
			public: true,
			i18nLabel: 'URL'
		...
		this.add(
			'Accounts_OAuth_MobileAuth_tokenPath',
		...
		this.add(
			'Accounts_OAuth_MobileAuth_authorizationPath',
		...
		this.add(
			'Accounts_OAuth_MobileAuth_identityPath',
		...
		this.add('Accounts_OAuth_MobileAuth_scope', 'openid email profile', {
			type: 'string',
			enableQuery,
			public: true,
			i18nLabel: 'Accounts_OAuth_Custom_Scope'
		});
		this.add('Accounts_OAuth_MobileAuth_usernameField', 'UPN', {
			type: 'string',
			enableQuery,
			public: true,
			i18nLabel: 'Accounts_OAuth_Custom_Username_Field'
		});
		this.add('Accounts_OAuth_MobileAuth_nameField', 'displayName', {
			type: 'string',
			enableQuery,
			public: true,
			i18nLabel: 'Accounts_OAuth_Custom_Name_Field'
		});
		this.add('Accounts_OAuth_MobileAuth_accessTokenParam', 'access_token', {
			type: 'string',
			enableQuery,
			public: true,
			i18nLabel: 'Accounts_OAuth_Custom_Access_Token_Param'
		});
		this.add('Accounts_OAuth_MobileAuth_roleName', 'mobile-user', {
			type: 'string',
			enableQuery,
			public: true,
			i18nLabel: 'Accounts_OAuth_Custom_Role_Name'
		});
		this.add('Accounts_OAuth_MobileAuth_secret', '', {
			type: 'string',
			enableQuery,
			secret: true,
			i18nLabel: 'Accounts_OAuth_Custom_Secret'
		});
		this.add('Accounts_OAuth_MobileAuth_merge_users', true, {
			type: 'boolean',
			enableQuery,
			public: true,
			i18nLabel: 'Merge users'
		});
		this.add('Accounts_OAuth_MobileAuth_LoginMethod', 'automatic', {
			type: 'select',
			public: true,
			enableQuery,
			persistent: true,
			i18nLabel: 'Accounts_OAuth_MobileAuth_LoginMethod',
			values: [
				{
					key: 'automatic',
					i18nLabel: 'Automatic'
		...
		this.add('Accounts_OAuth_Custom-MobileAuth-token_sent_via', 'payload', {
			type: 'select',
		...
		this.add('Accounts_OAuth_MobileAuth_id', '', {
			type: 'string',
			enableQuery,
			i18nLabel: 'Accounts_OAuth_Custom_id'
		});
		this.add('Accounts_OAuth_MobileAuth_callback_url', '', {
			type: 'string',
			enableQuery,
			i18nLabel: 'Accounts_OAuth_Custom_Callback_Url'
		});
		return this.add('Accounts_OAuth_MobileAuth_login_style', 'redirect', {
			type: 'select',
			enableQuery,
...
settings.addGroup('General', function () {
	...
	this.add('Mute_Rooms', true, {
		type: 'boolean',
		public: true
	});
	this.add('Enable_Rooms_Archive', false, {
		type: 'boolean',
		public: true
	});
	...
	this.add('Message_History_Time_Limit_Enabled', true, {
		type: 'boolean',
		public: true
	});
	this.add('Message_History_Time_Limit_In_Hours', 48, {
		type: 'int',
		public: true
	});
	...
	this.add('Contact_us_phone_number', '050-1234567', {
		type: 'string',
		public: true
	});
	this.add('Mobile_maintenance_phone_number', '03-6751324', {
		type: 'string',
		public: true
	});
	this.add('Dev_team_phone_number', '03-6781324', {
		type: 'string',
		public: true
	});
	this.add(
		'Dev_team_phone_number_For_Home_Page',
		'מטכ"לי - 03-675573 / 03-6781324',
		{
			type: 'string',
			public: true
		}
	...
	this.section('UTF8', function () {
		this.add('UTF8_Names_Validation', '[\\-.\'"\\w א-ת]+', {
			type: 'string',
			public: true,
			i18nDescription: 'UTF8_Names_Validation_Description'
		});
		this.add('UTF8_Channel_Names_Validation', '[\\-.\'"\\w א-ת]{1,40}', {
			type: 'string',
			public: true
		});
		this.add('UTF8_Channel_Topic_Validation', '[\\-.\'"\\w א-ת]{1,60}', {
			type: 'string',
			public: true
		});
		this.add(
			'UTF8_Channel_Announcment_Validation',
			'[\\-.\'"\\w א-ת]{1,60}',
			{
				type: 'string',
				public: true
	...
	this.section('Classification', function () {
		this.add('Classification_Enabled', false, {
			type: 'boolean',
			public: true
		});
		this.add('Open_shos_minimum_classification', 3, {
			type: 'int',
			public: true
		});
		this.add('Classification_Shos_Enabled', true, {
			type: 'boolean',
			public: true
		});
		this.add('Classification_Mirage_Dummy_Route_Enabled', false, {
			type: 'boolean',
			public: true
		});
		this.add(
			'Classification_Mirage_Url',
			'https://rockettar-rocketchat.40.114.31.51.nip.io/api/v1',
			{
				type: 'string',
				public: true
			}
		);
		this.add('Classification_Mirage_Api_Key', '', {
			type: 'string',
			public: true
		});
		this.add('Classification_Mirage_Api_Version', 6, {
			type: 'int',
			public: true
		});
		this.add(
			'Classification_Fetch_Classification_From_Mirage_On_Every_User_Creation',
			false,
			{
				type: 'boolean',
				public: true
		...
		this.add(
			'Classification_Fetch_Classification_From_Mirage_On_Oauth_User_Creation',
			false,
			{
				type: 'boolean',
				public: true
		...
		this.add('Default_Classification_For_User', 3, {
			type: 'int',
			public: true
		});
		this.add('Default_Classification_For_Group', 3, {
			type: 'int',
			public: true
		});
		this.add('Default_Classification_For_Channel', 5, {
			type: 'int',
			public: true
		});
		return this.add(
			'Classification_json',
			'[{"id": "1", "name": "shos"},{"id": "3", "name": "topSecret"},{"id": "5", "name": "restricted"}]',
			{
				type: 'code',
				multiline: true,
				public: true
	...
	this.section('External_Writing', function () {
		this.add('External_Writing_Enabled', false, {
			type: 'boolean',
			public: false
		});
		this.add('External_Writing_Urls', 'https://service-write.com/', {
			type: 'string',
			public: true
		});
	});
	this.section('Users_Service', function () {
		this.add('Users_Service_Enabled', false, {
			type: 'boolean',
			public: false,
			i18nDescription: 'Update_UsersService_Description'
		});
		this.add('Users_Service_Url', 'https://users-service.com/', {
			type: 'string',
			public: true
		});
		this.add(
			'Users_Service_Agent_To_Service',
			`{
			"Android": "mobileauth",
			"Mozilla": "oidc"
}`,
	...
	this.section('User_Action_Origin', function () {
		this.add('User_Action_Enabled', false, {
			type: 'boolean',
			public: false,
			i18nDescription: 'User_Action_Description'
		});
		this.add('User_Default_Agent', 'unknown', {
			type: 'string',
			public: false
		});
		this.add(
			'User_Action_Regex_To_From',
			`{
					"DEFAULT_CLIENT": "unknown",
					"Windows|Macintosh|PowerPC|Linux|Solaris|SunOS|BSD": "web",
	...
	this.section('Room_Info', function () {
		this.add('Show_Shared_Groups_Button', false, {
			type: 'boolean',
			public: true
		});
		this.add('Shared_Groups_Modal_Content', '', {
			type: 'code',
			multiline: true,
			public: true
		});
...
settings.addGroup('Message', function () {
	this.section('Message_Attachments', function () {
		...
		this.add('Message_Enable_Get_Link', false, {
			type: 'boolean',
			public: true
		});
		this.add('Message_Enable_Reply_directly', false, {
			type: 'boolean',
			public: true
		});
		this.add('Message_Enable_Report', false, {
			type: 'boolean',
			public: true
		});
		this.add('Message_Mark_As_Unread_Enabled', false, {
			type: 'boolean',
			public: true
		});
	...
	this.section('Message_Audio', function () {
		this.add('Message_AudioRecorderEnabled', false, {
			type: 'boolean',
			public: true,
	...
	this.section('Name_Colors', function () {
		this.add('Name_Colors_Enabled', true, {
			type: 'boolean',
			public: true
		});
		return this.add(
	...
	this.add('Message_MaxForwardMessages', 10, {
		type: 'int',
		public: true
	});
	...
	this.add('Allow_Prune_Messages', false, {
		type: 'boolean',
		public: true
	});
	this.add('Allow_Export_Messages', false, {
		type: 'boolean',
		public: true
	});
	this.add('Message_AlwaysSearchRegExp', true, {
		type: 'boolean'
	});
	...
	this.add('Message_NumberOfMessagesToLoadFromHistory', 50, {
		type: 'int',
		public: true
	});
	this.add('Message_AllowConvertLongMessagesToAttachment', false, {
		type: 'boolean',
		public: true
	});
	this.add('Message_ShowFormattingTips', false, {
		type: 'boolean',
		public: true
	});
...
settings.addGroup('Layout', function () {
	this.section('Content', function () {
		...
		this.add('Layout_Home_Support_Group_Link', '', {
			type: 'string',
			public: true
		});

		this.add('Layout_Home_PM_Name', 'רועי שקד', {
			type: 'string',
			public: true
		});
		...
		this.add('Layout_Support_Widget', '', {
			i18nDescription: 'Layout_Support_Widget_Description',
			type: 'code',
			code: 'text/html',
			multiline: true
		});
		this.add('Layout_Developer_Page', '[]', {
			type: 'code',
			code: 'text/html',
			multiline: true,
			public: true
		});
		this.add('Layout_Questions_And_Answers_Page', '[]', {
			type: 'code',
			code: 'text/html',
			multiline: true,
			public: true
		});
		this.add('Special_Key_Json_Array_Page_Content', '%%', {
			type: 'string',
			public: true
		});
		this.add(
	...
	this.section('Browser_Support', function () {
		this.add('Browser_Support_Header', 'תתחדשו!', {
			type: 'string',
			multiline: true,
			public: true
		});
		this.add(
			'Browser_Support_Secondery_Header',
			"גרסת הצ'אט המבצעי זמינה להורדה",
			{
				type: 'string',
				multiline: true,
				public: true
		...
		this.add('Browser_Support_Button_Text', 'הורידו כאן', {
			type: 'string',
			multiline: true,
			public: true
		});
		this.add(
			'Browser_Support_Tooltip_Text',
			"אלקטרון זו גרסת desktop של הצ'אט המבצעי, כולם יכולים להוריד אותה ללא עזרה של המחשוב ביחידה",
			{
				type: 'string',
				multiline: true,
				public: true
		...
		this.add('Disallowed_Browsers', '["IE","Firefox"]', {
			type: 'code',
			multiline: true,
			public: true
		});
		this.add(
			'Allowed_Browsers',
			'[{"name": "Chrome", "fromVersion": 52}, {"name": "Edge", "fromVersion": 0}, {"name": "Safari", "fromVersion": 0}]',
			{
				type: 'code',
				multiline: true,
				public: true
		...
		return this.add('Electron_Link', '', {
			type: 'string',
			public: true
		});
	});
	this.section('Custom_Whats_New', function () {
		this.add('Whats_new_enabled', true, {
			type: 'boolean',
			public: true
		});
		this.add('Whats_New_Content', '', {
			type: 'code',
			multiline: true,
			public: true
		});
		return this.add('Whats_new_content_mobile', '', {
			type: 'code',
			multiline: true,
			public: true
		});
	});
	this.section('Cargo_Integration', function () {
		this.add(
			'Bad_File_Size_Message_Header',
			'מצטערים, לא ניתן לעלות קובץ מעל 30 מגה',
			{
				type: 'string',
				public: true
			}
		...
		this.add(
			...
			'אם ברצונך לשתף קובץ זה, ניתן לפנות למערכת Cargo',
			{
				type: 'string',
				public: true
			}
		...
		this.add('Modal_Additional_Url', '', {
			type: 'string',
			public: true
		});

		this.add('Modal_Additional_Url_Text', 'משתפים פעם ראשונה? התחילו כאן', {
			type: 'string',
			public: true
		});
	});
...
settings.addGroup('Logs', function () {
	...
	this.add('Enable_Stream_Notification_Logs', false, {
		type: 'boolean',
		public: true
	});
	...
	this.add('Log_Trace_API_Responses', false, {
		type: 'boolean'
	});

	this.add(
		'Log_API_Routes_To_Exclude_Responses_From',
		"['settings.public', 'commands.list', 'loadHistory', 'statistics']",
		{
			type: 'code',
			enableQuery: {
				_id: 'Log_Trace_API_Responses',
				value: true
			},
			i18nDescription:
				'Log_API_Routes_To_Exclude_Responses_From_Description'
		}
	);
	...
	this.add('Android_Logs_Enabled', true, {
		type: 'boolean',
		public: true
	});
...
settings.addGroup('Rate Limiter', function () {
	this.section('DDP Rate Limiter', function () {
		...
		this.add('DDP_Rate_Limit_Connection_Enabled', true, {
			type: 'boolean'
		});
		this.add('DDP_Rate_Limit_Connection_Requests_Allowed', 600, {
			type: 'int',
			enableQuery: {
				_id: 'DDP_Rate_Limit_Connection_Enabled',
				value: true
			}
		});
