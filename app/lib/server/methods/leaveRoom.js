...
import { deleteRoom, removeUserFromRoom } from '../functions';
import { roomTypes, RoomMemberActions } from '../../../utils/server';

Meteor.methods({
	leaveRoom(rid, extraData = {}) {
		check(rid, String);
		...
		const numOfUsersInRoom = Subscriptions.findByRoomId(room._id).count();
		...
		return removeUserFromRoom(rid, user, {}, extraData);
	}
});
