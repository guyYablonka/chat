...
Meteor.methods({
	'livechat:getInitialData'(visitorToken, departmentId) {
		...
		info.offlineSuccessMessage =
			initSettings.Livechat_offline_success_message;
		info.offlineUnavailableMessage =
		...
		info.videoCall =
			initSettings.Livechat_videocall_enabled === true &&
		...
		info.allowSwitchingDepartments =
