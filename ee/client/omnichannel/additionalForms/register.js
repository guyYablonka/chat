...
hasLicense('livechat-enterprise').then(enabled => {
	...
	registerForm({
		useCustomFieldsAdditionalForm: () =>
			useMemo(
				() => lazy(() => import('./CustomFieldsAdditionalForm')),
				[]
			)
	});
	registerForm({
		useMaxChatsPerAgent: () =>
			useMemo(() => lazy(() => import('./MaxChatsPerAgent')), [])
	});
	registerForm({
	...
	registerForm({
		useEeNumberInput: () =>
			useMemo(() => lazy(() => import('./EeNumberInput')), [])
	});
	registerForm({
		useEeTextAreaInput: () =>
			useMemo(() => lazy(() => import('./EeTextAreaInput')), [])
	});
	registerForm({
		useEeTextInput: () =>
			useMemo(() => lazy(() => import('./EeTextInput')), [])
	});
	registerForm({
		useDepartmentForwarding: () =>
			useMemo(() => lazy(() => import('./DepartmentForwarding')), [])
	});
	registerForm({
	...
	registerForm({
		useCurrentChatTags: () =>
			useMemo(() => lazy(() => import('../tags/CurrentChatTags')), [])
	});
	registerForm({
		useContactManager: () =>
			useMemo(
				() => lazy(() => import('../additionalForms/ContactManager')),
				[]
			)
	});
});
